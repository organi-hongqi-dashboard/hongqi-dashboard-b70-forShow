...
class SpecificCarStatus : public CarStatus
{
    ...
    Q_PROPERTY(bool sysFault MEMBER m_sysFault NOTIFY sysFaultChanged)
    ...
    Q_PROPERTY(qreal coolantCurrentTemp MEMBER m_coolantCurrentTemp NOTIFY coolantCurrentTempChanged)
    Q_PROPERTY(qreal generatorPower MEMBER m_generatorPower NOTIFY generatorPowerChanged)
